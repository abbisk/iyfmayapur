...
import { BookOpen, HeartHandshake, Library, Landmark, Video } from 'lucide-react'

const QUICK_LINKS = [
  { id: 1, title: 'His Life', sub: 'Journey & Mission', icon: BookOpen, href: '#life' },
  { id: 2, title: 'Teachings', sub: 'Timeless Wisdom', icon: HeartHandshake, href: '#teachings' },
  { id: 3, title: 'His Books', sub: 'Sacred Literature', icon: Library, href: '#books' },
  { id: 4, title: 'Mission', sub: 'Global Impact', icon: Landmark, href: '#mission' },
  { id: 5, title: 'Media', sub: 'Photos & Videos', icon: Video, href: '#media' },
]
...
const SpHero = () => {
  return (
    <section className="relative w-full bg-[#120d09] text-white overflow-visible">
      ...
      <div className="relative w-full max-w-7xl mx-auto px-6 sm:px-12 lg:px-16 pt-8 pb-28 sm:pb-16 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center min-h-[580px] lg:min-h-[640px]">
        ...
        <div className="lg:col-span-7 flex flex-col items-start gap-4 sm:gap-5 text-left z-10">
          ...
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-serif leading-[1.12] tracking-tight">
            <span className="text-white font-normal block">His Divine Grace</span>
          ...
          <p className="text-xs sm:text-sm text-stone-200 font-poppins max-w-lg leading-relaxed">
            The visionary who brought ancient Vedic wisdom to the world with unwavering devotion and compassion.
          </p>

          {/* Quote Block */}
          <div className="mt-2 border-l-2 border-[#d4af37]/80 pl-4 py-1.5 flex items-start gap-3 bg-white/[0.03] rounded-r-lg max-w-xl">
            <span className="text-2xl font-serif text-[#d4af37] leading-none select-none">❝</span>
            <div>
              <p className="text-xs sm:text-sm italic text-stone-200 font-serif leading-relaxed">
                Let people think that what I am doing is rascaldom, but I am fully satisfied to deliver this message of Kṛṣṇa consciousness.
              </p>
        ...
        {/* Right Side: Image with Golden Glow Effect (5 cols) */}
      ...
      {/* Floating Overlapping Quick-Links Bar */}
